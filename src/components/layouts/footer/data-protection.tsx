...
export default function DataProtection() {
  return (
    <div className="text-secondary-text [&>h3]:text-[30px] [&>h3]:font-bold [&>p]:leading-[26px] [&>p]:tracking-wider">
      <h2 className="mb-[30px] text-center text-[40px] font-bold">
        Datenschutz
      </h2>
      <p>
        <strong>Hinweis zum Geltungsbereich</strong>
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        <strong>Vorwort zur Datenschutzerklärung</strong>
      </p>
      <br />
      <p>
        Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen.
        Datenschutz hat einen besonders hohen Stellenwert für die
        Geschäftsleitung der commsult AG. Eine Nutzung der Internetseiten der
        commsult AG ist grundsätzlich ohne jede Angabe personenbezogener Daten
        ...
        Anschrift, E-Mail-Adresse oder Telefonnummer einer betroffenen erson,
        erfolgt stets im Einklang mit der Datenschutz-Grundverordnung und in
        Übereinstimmung mit den für die commsult AG geltenden landesspezifischen
        ...
        <br />
        <br />
        Die commsult AG hat als für die Verarbeitung Verantwortlicher zahlreiche
      ...
      <br />
      <p>
        Die Datenschutzerklärung der commsult AG beruht auf den
      ...
      <br />
      <p>
        <strong>a) Verantwortlichkeit für die Datenverarbeitung</strong>
        <br />
        ...
        commsult AG
        <br />
        vertreten durch den Vorstand: Michael Buschner (Vors.), Stefan Richter,
        ...
        E-Mail:{" "}
        <Button variant={"link"} size={"sm"} shrink asChild>
          <a href="mailto:office@commsult.de">office@commsult.de</a>
        </Button>
        <br />
        Website:{" "}
        <Button variant={"link"} size={"sm"} shrink asChild>
      ...
      <br />
      <p>
        <strong>b) Datenschutzbeauftragter</strong>
        <br />
        ...
        E-Mail:{" "}
        <Button variant={"link"} size={"sm"} shrink asChild>
          <a href="mailto:tobias.schenke@commsult.de">
      ...
      <p>
        ...
        <br />
        <br />
        Durch den Einsatz von Cookies kann die commsult AG den Nutzern dieser
      ...
      <p>
        ...
        erhobenen Daten und Informationen werden durch die commsult AG daher
      ...
      <br />
      <p>
        Auf der Internetseite der commsult AG wird den Benutzern die Möglichkeit
      ...
      <p>
        ...
        Zählpixels kann die commsult AG erkennen, ob und wann eine E-Mail von
        ...
        Newsletters deutet die commsult AG automatisch als Widerruf.
      </p>
      <br />
      <br />
      ...
      <p>
        ...
        Person die Löschung von personenbezogenen Daten, die bei der commsult AG
        ...
        Mitarbeiter der commsult AG wird veranlassen, dass dem Löschverlangen
        unverzüglich nachgekommen wird. Wurden die personenbezogenen Daten von
        der commsult AG öffentlich gemacht und ist unser Unternehmen als
        Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
        personenbezogenen Daten verpflichtet, so trifft die commsult AG unter
        ...
        erforderlich ist. Der Mitarbeiter der commsult AG wird im Einzelfall das
      ...
      <p>
        ...
        der commsult AG gespeichert sind, verlangen möchte, kann sie sich hierzu
        jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
        wenden. Der Mitarbeiter der commsult AG wird die Einschränkung der
      ...
      <p>
        ...
        auf Datenübertragbarkeit gemäß Art. 20 Abs. 1 DS-GVO das Recht, zu
        ...
        betroffene Person jederzeit an einen Mitarbeiter der commsult AG wenden.
      </p>
      <br />
      <p>
        ...
        gestütztes Profiling. Die commsult AG verarbeitet die personenbezogenen
        ...
        Verteidigung von Rechtsansprüchen. Verarbeitet die commsult AG
        ...
        gegenüber der commsult AG der Verarbeitung für Zwecke der Direktwerbung,
        so wird die commsult AG die personenbezogenen Daten nicht mehr für diese
        Zwecke verarbeiten. Zudem hat die betroffene Person das Recht, aus
        Gründen, die sich aus ihrer besonderen Situation ergeben, gegen die sie
        betreffende Verarbeitung personenbezogener Daten, die bei der commsult
        AG zu wissenschaftlichen oder historischen Forschungszwecken oder zu
        ...
        direkt jeden Mitarbeiter der commsult AG oder einen anderen Mitarbeiter
        wenden. Der betroffenen Person steht es ferner frei, im Zusammenhang mit
      ...
      <p>
        ...
        Einwilligung der betroffenen Person, trifft die commsult AG angemessene
      ...
      <br />
      <h3>
        12. Datenschutzbestimmungen zu Einsatz und Verwendung von Getty Images
        Bildern
      </h3>
      <br />
      <p>
        Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite
        Komponenten des Unternehmens Getty Images integriert. Getty Images ist
        eine amerikanische Bildagentur. Eine Bildagentur ist ein Unternehmen,
        welches auf dem Markt Bilder und anderes Bildmaterial anbietet.
        Bildagenturen vermarkten in der Regel Fotografien, Illustrationen und
        Filmmaterial. Über eine Bildagentur lizensieren unterschiedliche Kunden,
        insbesondere Internetseitenbetreiber, Redaktionen von Print- und
        TV-Medien und Werbeagenturen, die von ihnen eingesetzten Bilder.
        <br />
        <br />
        Betreibergesellschaft der Getty-Images-Komponenten ist die Getty Images
        ...
        Einbetten ist die Einbindung oder Integration eines bestimmten fremden
        Inhalts, beispielsweise von Text-, Video- oder Bild-Daten, die von einer
        fremden Internetseite bereitgestellt werden und dann auf der eigenen
        Internetseite erscheinen. Zur Einbettung wird ein sogenannter
        Einbettungscode verwendet. Ein Einbettungscode ist ein HTML-Code, der
        von einem Internetseitenbetreiber in eine Internetseite integriert wird.
        Wurde von einem Internetseitenbetreiber ein Einbettungscode integriert,
        ...
        Anzeige der fremden Inhalte werden die externen Inhalte unmittelbar von
        der anderen Internetseite geladen. Getty Images stellt unter dem Link{" "}
        <Button variant={"link"} size={"sm"} shrink asChild>
          <a href="http://www.gettyimages.de/resources/embed" target="_blank">
        ...
        Bildanzeige der Bilder von Getty Images ermöglicht, wird die IP-Adresse
        des Internetanschlusses, über welchen die betroffene Person auf unsere
        Internetseite zugreift, an Getty Images übertragen. Ferner erfasst Getty
        Images unsere Internetseite, den genutzten Browsertyp, die
        Browsersprache, den Zeitpunkt und die Länge des Zugriffs. Darüber hinaus
        kann Getty Images Navigationsinformationen, das sind Informationen
        darüber, welche unserer Unterseiten von der betroffenen Person besucht
        und welche Links angeklickt wurden, sowie andere Interaktionen, die die
        ...
        <Button variant={"link"} size={"sm"} shrink asChild>
          <a
            href="https://www.gettyimages.de/company/privacy-policy"
            target="_blank"
          >
      ...
      <p>
        ...
        den Suchmaschinenergebnissen von Google als auch im Google-Werbenetzwerk
        zu schalten. Google AdWords ermöglicht es einem Werbetreibenden, vorab
      ...
      <br />
      <br />
      <h3>15. Verwendung von Webfonts</h3>
      <br />
      <p>
      ...
      <br />
      <h3>
        17. Berechtigte Interessen an der Verarbeitung, die von dem
      ...
      <br />
      <br />
      <h3>18. Dauer, für die die personenbezogenen Daten gespeichert werden</h3>
      <br />
      <p>
      ...
      <p>
        ...
        automatische Entscheidungsfindung oder ein Profiling. Diese
        ...
        <Button variant={"link"} size={"sm"} shrink asChild>
          <a href="https://www.wbs-law.de/" target="_blank">
      ...
      <p>
        <strong>f) Recht auf Datenübertragbarkeit</strong>
        <br />
        commsult hat im Zeitraum vom Mai 2017 bis März 2018 einer Mitarbeiterin
        die Weiterbildung zur Feel Good Managerin ermöglicht. Diese Maßnahme
        wurde gefördert durch das Ministerium für Arbeit, Soziales, Gesundheit,
        Frauen und Familie aus Mitteln des Europäischen Sozialfonds und des
        Landes Brandenburg.
      </p>
      <br />
      <div>
      ...
      <div>
        <Button asChild>
          <a href="http://www.ec.europa.eu/" target="_blank">
            <span>EU Kommission</span>
            <ArrowRight width={18} />
          </a>
        </Button>
      </div>
